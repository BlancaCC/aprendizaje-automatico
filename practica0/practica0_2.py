...
len_target = len(y/ numero_clases)

datos_por_clases = [X[ i*len_target:(i+1)*len_target] for i in range(numero_clases) ]

[ print( i) for i in datos_por_clases]


""" DE ESTA MANERA LA DIVISIÓN NO ES PERFECTA 
test_size = 0.25
